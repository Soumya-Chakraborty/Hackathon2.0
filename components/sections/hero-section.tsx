...
export default function HeroSection({ sectionRef, aboutRef, registerRef }: HeroSectionProps) {
  ...
  return (
    <section
      ref={sectionRef}
      id="home"
      className="relative min-h-screen flex items-center justify-center overflow-hidden py-12 sm:py-0"
    >
      <ParticleBackground />
      ...
      <div className="container mx-auto px-4 sm:px-6 relative z-10">
        <div className="max-w-4xl mx-auto text-center">
          ...
          <motion.h1
            ...
            className="text-3xl sm:text-5xl md:text-7xl font-bold mb-4 sm:mb-6 font-mono"
          >
          ...
          <motion.p
            ...
            className="text-base sm:text-xl text-white/70 mb-6 sm:mb-8 font-mono"
          >
          ...
          >
            ...
            >
              <Button
                ...
                className="w-full sm:w-auto bg-gradient-to-r from-blue-400 to-purple-500 hover:opacity-90 transition-all duration-300 font-mono relative overflow-hidden group text-sm sm:text-base"
              >
            ...
            >
              <Button
                ...
                className="w-full sm:w-auto border-white/20 hover:bg-white/10 transition-all duration-300 font-mono relative overflow-hidden group text-sm sm:text-base"
              >
          ...
          <div className="mt-12 sm:mt-16 relative">
            ...
            <div className="relative">
              <p className="text-4xl sm:text-6xl md:text-8xl font-bold text-transparent bg-clip-text bg-gradient-to-r from-cyan-400 to-pink-400 animate-pulse font-mono mb-2 sm:mb-4">
                COMING SOON
              </p>
              <p className="text-lg sm:text-2xl text-white/90 font-mono">
